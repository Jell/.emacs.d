...
(custom-set-faces
 ...
 '(diff-file-header ((t (:background "#002b36" :foreground "mediumpurple3" :weight bold))))
 ...
 '(diff-removed ((t (:inherit diff-changed :foreground "IndianRed1" :inverse-video nil :underline nil :slant normal :weight normal))))
 '(erm-syn-errline ((t (:underline "Red"))))
 '(erm-syn-warnline ((t (:underline "Orange"))))
 '(magit-diff-add ((t (:inherit diff-added :foreground "#98e27e"))))
 '(magit-diff-del ((t (:inherit diff-removed :foreground "#e9635f"))))
 ...
 '(mumamo-background-chunk-submode3 ((t (:background "#042028"))) t)
 '(mumamo-background-chunk-submode4 ((t (:background "#042028"))) t)
